...
![Version](https://img.shields.io/badge/version-3.9.28-40c9ff)
...
- SDK-owned ad animations are disabled by default and can be enabled through Firebase Remote Config: `zeywin_native_banner_animations_enabled`, `zeywin_native_banner_slide_enabled`, `zeywin_native_banner_attention_enabled`, `zeywin_native_banner_shine_enabled`, `zeywin_native_banner_variant_rotation_enabled`, `zeywin_popup_animations_enabled`, `zeywin_popup_transition_enabled`, and `zeywin_popup_gold_flash_enabled`.
